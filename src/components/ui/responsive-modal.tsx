...
const ResponsiveModalVariants = cva(
  cn(
    ...
    "left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] lg:w-full lg:max-w-lg lg:border lg:duration-200 lg:data-[state=open]:animate-in lg:data-[state=closed]:animate-out lg:data-[state=closed]:fade-out-0 lg:data-[state=open]:fade-in-0 lg:data-[state=closed]:zoom-out-95 lg:data-[state=open]:zoom-in-95 lg:rounded-xl"
  ),
  {
    variants: {
      side: {
        // Apply the centering logic to all sides
        top: "left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] border-b rounded-b-xl max-h-[90%] lg:h-fit data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
        bottom:
          "left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] border-t lg:h-fit max-h-[90%] rounded-t-xl data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
        left: "left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] w-3/4 border-r rounded-r-xl data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm",
        right:
          "left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] w-3/4 border-l rounded-l-xl data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "bottom",
